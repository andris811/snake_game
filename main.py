...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Snake by AVDev")
    ...
    def play_sound(self, sound):
        audio = pygame.mixer.Sound(f"resources/{sound}.mp3")
    ...
    def play(self):
        ...
        for i in range(3,self.snake.length):
            if self.is_collision(self.snake.x[0], self.snake.y[0], self.snake.x[i], self.snake.y[i]):
                ...
                raise "Hit yourself error"

         #snake colliding with the boundries of window
